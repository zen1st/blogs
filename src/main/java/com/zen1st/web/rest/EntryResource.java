...
import com.zen1st.domain.Entry;

import com.zen1st.repository.EntryRepository;
...
public class EntryResource {
    ...
    @GetMapping("/entries")
    @Timed
    public ResponseEntity<List<Entry>> getAllEntries(@ApiParam Pageable pageable, HttpServletRequest request) {
        log.debug("REST request to get a page of Entries");

    	Page<Entry> page;
    	
    	//Admins have access to all blog entries
